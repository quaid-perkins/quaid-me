  ...
  return (
    <>
      ...
      <DrawerPrimitive.Content
        ...
        class={cx(
          "fixed z-50 flex h-auto flex-col border-zinc-300 bg-zinc-200 after:absolute after:bg-inherit data-[transitioning]:transition-transform data-[transitioning]:duration-500 data-[transitioning]:ease-[cubic-bezier(0.32,0.72,0,1)] dark:border-zinc-700 dark:bg-zinc-900",
          context.side() === "bottom" && [
      ...
      >
        <Show when={props.withHandle}>
          <div
            class={cx(
              "shrink-0 self-center rounded-full bg-muted",
